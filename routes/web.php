...
Route::middleware(['web', 'IsInstalled', 'switch_languages'])->group(function () {
    ...
    //, 'is_active' cut from middleware below
    Route::middleware(['web', 'auth', 'is_admin', 'switch_languages'])->group(function () {
        ...
        Route::post('/quickupdate/childcategory/{id}', 'QuickUpdat    //, \'is_active\' cut from middleware below
eController@childcategoryQuick')->name('childcategory.quick');
...
//        Route::get('requestinstructor', 'InstructorRequestController@index');//added  BY ME
